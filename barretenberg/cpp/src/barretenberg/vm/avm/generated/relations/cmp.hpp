...
template <typename FF_> class cmpImpl {
  public:
    ...
    static constexpr std::array<size_t, 26> SUBRELATION_PARTIAL_LENGTHS = { 3, 2, 4, 5, 3, 3, 3, 3, 3, 3, 3, 3, 5,
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        }
        {
            ...
            auto tmp =
                ((new_term.cmp_op_eq + new_term.cmp_op_gt) * (new_term.cmp_result * (FF(1) - new_term.cmp_result)));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.cmp_op_gt * (new_term.cmp_cmp_rng_ctr - FF(5)));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((new_term.cmp_cmp_rng_ctr *
                         (((FF(1) - new_term.cmp_sel_rng_chk) * (FF(1) - new_term.cmp_op_eq_diff_inv)) +
                          new_term.cmp_op_eq_diff_inv)) -
                        new_term.cmp_sel_rng_chk);
            tmp *= scaling_factor;
            std::get<17>(evals) += typename Accumulator::View(tmp);
        }
        {
            using Accumulator = typename std::tuple_element_t<18, ContainerOverSubrelations>;
            auto tmp = ((new_term.cmp_a_lo_shift - new_term.cmp_b_lo) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
            std::get<18>(evals) += typename Accumulator::View(tmp);
        }
        {
            using Accumulator = typename std::tuple_element_t<19, ContainerOverSubrelations>;
            auto tmp = ((new_term.cmp_a_hi_shift - new_term.cmp_b_hi) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((new_term.cmp_b_lo_shift - new_term.cmp_p_sub_a_lo) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((new_term.cmp_b_hi_shift - new_term.cmp_p_sub_a_hi) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((new_term.cmp_p_sub_a_lo_shift - new_term.cmp_p_sub_b_lo) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((new_term.cmp_p_sub_a_hi_shift - new_term.cmp_p_sub_b_hi) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((new_term.cmp_p_sub_b_lo_shift - new_term.cmp_res_lo) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((new_term.cmp_p_sub_b_hi_shift - new_term.cmp_res_hi) *
                        (new_term.cmp_op_gt_shift - new_term.cmp_sel_rng_chk_shift));
            tmp *= scaling_factor;
